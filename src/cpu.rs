    ...
    pub fn call(&mut self, pc: u16) {
        ...
        loop {
            match (self.bank(), self.pc) {
                ...
                (_, 0x0919) => crate::game::home::overworld::load_north_south_connections_tile_map(self),
                (_, 0x093d) => crate::game::home::overworld::load_east_west_connections_tile_map(self),
                ...
                (_, 0x0a1c) => crate::game::home::overworld::collision_check_on_land(self),
                (_, 0x0a79) => crate::game::home::overworld::check_tile_passable(self),
                ...
                (_, 0x0d2c) => crate::game::home::overworld::run_map_script(self),
                ...
                (_, 0x0dab) => crate::game::home::overworld::load_map_header(self),
                ...
                (_, 0x0ff0) => crate::game::home::overworld::is_spinning(self),
