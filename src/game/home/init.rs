...
//         cpu.setdi = 0;
//         cpu.pc = 0x1d14;
//         cpu.write_byte(R_IF, 0);
//         cpu.write_byte(R_IE, 0);
//         cpu.write_byte(R_SCX, 0);
//         cpu.write_byte(R_SCY, 0);
//         cpu.write_byte(R_SB, 0);
//         cpu.write_byte(R_SC, 0);
//         cpu.write_byte(R_WX, 0);
//         cpu.write_byte(R_WY, 0);
//         cpu.write_byte(R_TMA, 0);
//         cpu.write_byte(R_TAC, 0);
//         cpu.write_byte(R_BGP, 0);
//         cpu.write_byte(R_OBP0, 0);
//         cpu.write_byte(R_OBP1, 0);
//         cpu.pc = 0x1d2c;
//         yield_from!(cpu.cycle(12 * 13));
